        ...
        CreateThread(function()
            ...
            while open do 
                RageUI.IsVisible(MenuLocation, function()
                    RageUI.Separator("  ↓ _________________ ~o~Location de véhicules _________________ ~s~↓")
                    ...
                    RageUI.Separator("  ↓ _________________ ~b~Retour _________________ ~s~↓")
                    ...
                    RageUI.Separator("  ↓ _________________ ~r~Fermeture _________________ ~s~↓")
    ...
    while true do
		local wait = 750
            ...
            if dist <= Config.MarkerDistance then
                wait = 0
                ESX.ShowHelpNotification("Appuyer sur [~b~E~s~] pour accéder à la ~o~Location !")
